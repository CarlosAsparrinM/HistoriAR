                ...
                Column(
                  ...
                  children: [
                    _buildGuideStep(
                      '1',
                      'Arrastra para rotar',
                      'Usa un dedo para girar el ${widget.monument.culture ?? 'monumento'} sin moverlo de lugar.',
                    ),
                    const SizedBox(height: 10),
                    _buildGuideStep(
                      '2',
                      'Dos dedos para ajustar',
                      'Separa o junta los dedos para escalar; arrástralos juntos para mover el encuadre.',
                    ),
                    const SizedBox(height: 10),
                    _buildGuideStep(
                      '1s',
                      'Reposicionar con regla',
                      'Mantén 1 segundo para activar y luego toca un plano detectado.',
                    ),
                    const SizedBox(height: 10),
                    _buildGuideStep(
                      '2x',
                      'Centrar modelo',
                      'Haz doble toque para volver al tamaño y posición inicial.',
                    ),
                  ],
                ),
