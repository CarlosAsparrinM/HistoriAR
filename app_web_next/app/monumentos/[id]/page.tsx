...
export default async function MonumentPage({ params }: RouteProps) {
  ...
  return <div className="flutter-screen detail-screen">
    ...
    <AppHeader backHref="/explorar" /><div className="page-with-ad-space"><aside className="ad-gutter ad-gutter-left" aria-hidden="true"><AdBanner /></aside><article className="page detail">
    ...
    <AppFooter />
  </article><aside className="ad-gutter ad-gutter-right" aria-hidden="true"><AdBanner /></aside></div></div>;
}
